...
## Metadane
- Status: sceny RPG 001–025 zakończone i zapisane; scena 026 rozpoczyna się.
- Ostatnia sfinalizowana scena: `rpg/scenes/025-stanley-proba-opanowania-sytuacji.md`.
- Bieżący bazowy punkt kanonu: `novel/plan.md` — scena 26, **Ratowanie ciała Romana**.
- Perspektywa: Stanley Hutchins.
- Miejsce: Skyropula, centrum transferowe po katastrofie pierwszego pełnego transferu człowiek–człowiek.

## Stanley Hutchins
- Prowadzi projekt i czuje osobistą odpowiedzialność za Romana, który zgłosił się do eksperymentu, bo ufał Stanleyowi.
- Przy sprzecznych danych podczas transferu Romana zdecydował się kontynuować do 100%, uznając, że nie ma już bezpiecznego odwrotu.
...
- Zna hipotezę o możliwym transferze Romana do rekina, ale uważa ją za skrajnie niepewną.
- Nadal nie zna historii Oliwii.

## Aktywne wątki
- Ratowanie i zabezpieczenie ciała Romana jako potencjalnego przyszłego gospodarza dla odzyskanej świadomości.
- Bezpieczne wydobycie i wybudzenie Henry’ego po przywróceniu jego wzorca.
- Śledzenie oznaczonego rekina i weryfikacja, czy rzeczywiście zawiera wzorzec Romana.
- Ocena rozmiaru zniszczeń ośrodka i dalsza stabilizacja energetyki.
- Odpowiedzialność Stanleya za katastrofę i los Romana.
